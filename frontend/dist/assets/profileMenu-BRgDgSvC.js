import{n as f,l as L}from"./index-VYEbWczg.js";function A(i,r,n={}){const o=document.createElement("div");o.className=["fixed inset-0 z-40","bg-black/20 backdrop-blur-[2px]","opacity-0 pointer-events-none transition-opacity"].join(" ");const e=document.createElement("div");e.className=["fixed z-50 w-[22rem] max-w-[92vw] outline-none","rounded-2xl border border-white/60","bg-white/80 backdrop-blur-xl","shadow-2xl ring-1 ring-black/5","scale-95 opacity-0 pointer-events-none","transition duration-150 ease-out"].join(" "),e.setAttribute("role","menu"),e.setAttribute("tabindex","-1");const u=w(r.avatarPath);e.innerHTML=`
    <style>
