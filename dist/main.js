...
(_a = document.getElementById('nav-home')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
    isLocalMode = false;
...
(_b = document.getElementById('nav-game')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
    isLocalMode = true;
    gamePausedOnline = true;
    resetLocalGame();
    showView('view-game');
...
(_c = document.getElementById('nav-game-online')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
    isLocalMode = false;
    gamePausedLocal = true;
    showView('view-game');
    history.pushState(null, '', '/game');
